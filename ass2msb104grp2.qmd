...
In part B we have chosen the variables: Labour force, Unemployment and Population density. We will look in to each of these variable, and see how they are a potential a determaint factor for the regional inequality. Labour force is a variable which includes all persons how are both employed and unemployed. Its the total supply of the regions labour forsce. 
