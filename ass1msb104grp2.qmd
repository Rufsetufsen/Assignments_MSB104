...
In @lst-import, we use the `read_excel` function from the package `readxl` to read the downloaded GDP data from Eurostat into R.
...
```{r}
#| label: tbl-ginigdp
#| tbl-cap: "Calculated Gini coefficients per NUTS2-region - full table"
