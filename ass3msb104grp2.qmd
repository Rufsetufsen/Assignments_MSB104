...
```{r}
library(magrittr)
# Nonfunctioning code block as of 21/11
# Magefølelse - la til "group by NUTS2" på den lagga gdp-utrekninga i assignment 2. Har det laga følgefeil?
#Workforce
xsection2017 <- xsection2017 %>%
  mutate(Workforce_Class = cut_width(
    Workforce,
...
quantile(xsection2017$Workforce, probs = c(0, 1/3, 2/3, 1), na.rm = TRUE)
```
