...
as_flextable(
  lm(gini ~ Pop_km2 + chg_gdpc, data = xsection2017)
) |>
  colformat_double(j = 2, digits = 6) |>
  set_caption(
    caption = "Linear regression statistics for population density",
    html_escape = FALSE
  )

```

#### Linear regression statistics for labour force
...
as_flextable (lm(gini ~ chg_gdpc + Workforce, data = xsection2017
  ...
  colformat_double(j = 2, digits = 6)|>
set_caption(caption = "Linear regression statistics for labour force")
linear_Workforce <- lm(gini ~ chg_gdpc + Workforce, data = xsection2017)
```

#### Logarithmic regression statistics for labour force
...
#### Quadratic regression statistics for labour force

```{r}
#Quadratic function:
#| label: "tbl-Quadratic regression"
#| tbl-cap: "Quadratic regression statistics for labour force" 
#| title: "Quadratic regression statistics for labour force" 
...
#### Linear regression statistics for population density
...
#### Logarithmic regression statistics for population density
...
#### Quadratic regression statistics for population density
...
#### Linear regression statistics for Unemployment rate
...
as_flextable(lm(gini ~ chg_gdpc + Unemp_prct, data = xsection2017))%>%
  colformat_double(j = 2, digits = 6) %>%
  set_caption("Linear regression statistics for Unemployment rate")
linear_Unemp <- (lm(gini ~ chg_gdpc + Unemp_prct, data = xsection2017))
```

#### Logarithmic regression statistics for Unemployment rate
...
#### Quadratic regression statistics for Unemployment rate
