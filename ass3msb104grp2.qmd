...
```{r}
densitysliced <- cut(xsection2017$Pop_km2, breaks = quantile(xsection2017$Pop_km2, na.rm = TRUE), labels = c("Low density", "Medium density", "High density", "MegaUltradensity"))
table(densitysliced)
```
```{r}
#Population density
Pop_km2_segm <- xsection2017 %>%
