...
The data provided by Eurostat ccan be considered primary data because it is originally collected through official surveys and processed following established methodological standards for gathering information on specific topic within defined time periods.
...
The results hwo an estimated intercept of ($\hat{\alpha}=0.1336$), represetning the average level of nequality in regions with zero GDP-per-capita growth.
